...
/* eslint-typegen-hash: ku1U1AOxAPj5tvRfEFXjjlHIq52E8B_-MXbBZolp1L8 */
...
export interface RuleOptions {
  ...
  /**
   * Enforce proper position of the first element in astro
   * @see https://example.com/astro-first-element-line
   */
  'mine/astro-first-element-line'?: Linter.RuleEntry<[]>
  /**
   * Enforce no space in empty object
   * @see https://example.com/no-space-in-empty-block
   */
  'mine/no-space-in-empty-block'?: Linter.RuleEntry<[]>
  /**
